...
/*
    With locks f/w we can achieve synchronization.
    It provides advantages compared to thread synchronization.
    In thread synchronization, one thread acquires lock and all other threads waits
    till this thread has completed its task.
    Whereas, Lock f/w provides us to run two or more synchronized method concurrently.
 */
...
// Each 5 threads in DisplayJob and ReadJob will behave similary as thread synchronization.
// But both these jobs will run concurrently.
